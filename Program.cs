...
namespace Final_Project_Discount_Purchasing_and_Shipping
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            marketingArray.Add(new Marketing("P123", "coffee mug", 12.29m, 30, 20, 10, 5, 50, 30, 15, 10));
            marketingArray.Add(new Marketing("P987", "magnet, large", 3.29m, 25, 20, 10, 5, 50, 30, 15, 10));
            ...
            shippingArray.Add(new Shipping("S721", "Denver CO", 1500, 30, 50, 35, 20, 1000, 500, 100, 35m));
            shippingArray.Add(new Shipping("S678", "SLC UT", 3000, 50, 50, 35, 20, 1000, 500, 100, 35m));
